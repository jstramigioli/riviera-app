...
const factorNames = {
  ...
  'holiday': 'Feriado/Fin de semana largo',
...
function getFactorDescription(factor) {
  const descriptions = {
    ...
    'holiday': 'Influencia de los feriados y fines de semana largos (períodos de alta demanda) en los precios. Detecta automáticamente cuando feriados son adyacentes a fines de semana.',

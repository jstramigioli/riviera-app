    ...
    <div style={{ padding: '20px', maxWidth: '100%', overflow: 'hidden' }}>
      ...
      {!config.enabled && (
        <div style={{
          ...
          <strong style={{ fontSize: 'var(--font-size-xlarge)' }}>⚠️ Precios dinámicos desactivados</strong>
          <br />
                ...
                <div style={{ display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'space-between' }}>
                  <AnticipationFactorConfig
                    ...
                    onConfigChange={(anticipationConfig) => {
                      ...
                      handleChange('anticipationConfig', newConfig);
                    }}
                  />
                  <EditablePercentage
                ...
                <div style={{ display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'space-between' }}>
                  <WeekendFactorConfig
                    ...
                    onConfigChange={(weekendConfig) => {
                      ...
                      handleChange('weekendConfig', newConfig);
                    }}
                  />
                  <EditablePercentage
